export default {
    ...
    API_URL_DETAIL_REGISTER: '/master/knowledge_article_master/knowledge_article/register',
    API_URL_DETAIL_UPDATE: '/master/knowledge_article_master/knowledge_article/update',
