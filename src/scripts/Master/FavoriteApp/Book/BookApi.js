...
export default {
    ...
    API_URL_DETAIL: '/master/favorite_app/book/detail',
    API_URL_DETAIL_REGISTER: '/master/favorite_app/book/detail/register',
    API_URL_DETAIL_UPDATE: '/master/favorite_app/book/detail/update',
